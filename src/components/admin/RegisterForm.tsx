...
import { registerFromInvite } from "@/app/admin/register/actions";
  ...
  return (
    <form action={formAction} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        ...
        <Input id="repeat" name="repeat" type="password" autoComplete="new-password" required minLength={6} disabled={pending} />
      </div>
