...
import { LPTerminalNav } from "@lp/LPTerminalNav";
import { ContactFooter } from "@lp/sections/ContactFooter";
        ...
        <main className="bg-white">
          <section className="min-h-screen flex flex-col lg:items-center lg:justify-center px-4 pt-[120px] lg:pt-[160px] pb-[40px] lg:pb-[60px]">
            <div className="flex-1 lg:flex-none flex flex-col items-center justify-center text-center gap-6 lg:gap-8 max-w-[640px] mx-auto w-full">
              {/* Certified-check badge — blue burst + white check, matches
                  the LP accent palette. */}
              <div className="w-[120px] h-[120px] lg:w-[140px] lg:h-[140px] flex items-center justify-center drop-shadow-[0_16px_50px_rgba(0,102,255,0.25)]">
              ...
              <h1 className="font-sans font-bold text-[28px] sm:text-[34px] lg:text-[48px] leading-[1.1] tracking-[-1.12px] lg:tracking-[-1.92px] whitespace-nowrap">
                <span className="text-[#0066ff]">Thanks! </span>
                <span className="text-[#001f4d]">Your request is in.</span>
              </h1>

              <p className="font-sans font-normal text-base lg:text-xl leading-[1.5] tracking-[-0.3px] text-[#001f4d]/65 max-w-[520px]">
