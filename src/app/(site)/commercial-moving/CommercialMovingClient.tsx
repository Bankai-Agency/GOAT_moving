...
import { HowItWorksSection, EstimateIcon, PlanIcon, BoxIcon, TruckIcon } from "@site/sections/HowItWorksSection";
  ...
  return (
    <section className="relative h-screen min-h-[700px] lg:min-h-[900px] overflow-hidden bg-black">
      ...
      <div className="absolute inset-0 max-lg:top-[88px] max-lg:bottom-[51dvh]">
        <Image src="/images/commercial-moving-hero.png" alt="Commercial moving services in Vancouver WA and Portland OR" fill sizes="(max-width: 1024px) 200vw, 100vw" quality={90} className="object-cover object-[30%_center] lg:object-center" priority />
      ...
      <div className="relative h-full max-w-[1408px] mx-auto px-4 flex items-end pb-8 lg:pb-[72px]">
        <div className="flex flex-col gap-4 lg:gap-6">
          <h1 className="font-sans font-bold text-[40px] lg:text-[96px] leading-none tracking-[-1.2px] lg:tracking-[-2.88px]">
            <span className="text-[#FFE533]">Commercial Movers </span>
            <br />
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-6 lg:p-8 flex flex-col gap-4 lg:gap-5 min-h-[200px] lg:min-h-[240px]">
        <div
          className="w-12 h-12 lg:w-14 lg:h-14 rounded-lg lg:rounded-xl flex items-center justify-center shrink-0 transition-all duration-500"
          style={{
