...
/* Corp-site primary nav — port of Osmo Supply's "Mega Navigation
   (Directional Hover)" resource. Behaviour preserved verbatim from the
   source script; adapted to React/Next. All [data-...] attributes are
   load-bearing for the GSAP init logic — do not rename.

   Rendered once by (site)/layout.tsx so every corp page shares it. */
...
export function TerminalNav() {
  ...
  return (
    ...
    >
      ...
      >
        {/* Dark glass with warm yellow radial accent — mirrors the
           lp4 mobile-menu palette: dark base + #FFE533 glow in the
           top-left + a diagonal fade into a warm-dark corner so the
           menu reads as part of the brand's atmospheric surface. */}
        <div
          style={{
            position: "absolute",
            inset: 0,
        ...
        {/* Bottom CTA buttons — phone (outlined pill) + Quote MP5Button. */}
        <div
          style={{
            padding: "0 24px 32px",
            display: "flex",
