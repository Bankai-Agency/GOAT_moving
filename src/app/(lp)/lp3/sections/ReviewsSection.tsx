...
function SummaryCardDesktop() {
  return (
    <div className="lp1-review-card rounded-2xl p-8 flex flex-col justify-between h-[374px] w-[calc(100vw-64px)] min-w-[calc(100vw-64px)] lg:w-[340px] lg:min-w-[340px] shrink-0 grow-0 select-none">
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-3 items-center shrink-0">
            <a href={YELP_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full lp1-source-bubble hover:bg-[#FF2828] flex items-center justify-center transition-all duration-300 ease-out hover:scale-110">
              <Image src="/icons/yelp-white.svg" alt="Yelp" width={17} height={22} />
            </a>
            <a href={GOOGLE_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full lp1-source-bubble hover:bg-[#357DFF] flex items-center justify-center transition-all duration-300 ease-out hover:scale-110">
...
function SummaryCardMobile() {
  return (
    <div className="lp1-review-card rounded-2xl p-6 flex flex-col justify-between h-[250px] w-full select-none">
      <div className="flex flex-col gap-2">
        <div className="flex items-start justify-between">
          ...
          <div className="flex gap-3 items-center">
            <a href={YELP_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full lp1-source-bubble active:bg-[#FF2828] flex items-center justify-center transition-colors duration-200">
              <Image src="/icons/yelp-white.svg" alt="Yelp" width={17} height={22} />
            </a>
            <a href={GOOGLE_URL} target="_blank" rel="noopener noreferrer" className="w-14 h-14 rounded-full lp1-source-bubble active:bg-[#357DFF] flex items-center justify-center transition-colors duration-200">
              <Image src="/icons/google.svg" alt="Google" width={20} height={20} />
            </a>
          </div>
        </div>
...
function ReviewCardDesktop({ name, location, rating, text, avatar, source }: ReviewItem) {
  ...
  return (
    <div className="lp1-review-card hover:bg-[#FFE533] rounded-2xl p-8 h-[374px] overflow-hidden w-[calc(100vw-64px)] min-w-[calc(100vw-64px)] lg:w-[340px] lg:min-w-[340px] shrink-0 grow-0 select-none transition-all duration-300 ease-out hover:shadow-[0_12px_32px_rgba(255,229,51,0.15)] group/card">
...
function ReviewCardMobile({ name, location, rating, text, avatar, source }: ReviewItem) {
  const reviewUrl = source === "yelp" ? YELP_URL : GOOGLE_URL;
  return (
    <div className="lp1-review-card rounded-2xl p-5 h-[360px] overflow-hidden w-[calc(100vw-64px)] min-w-[calc(100vw-64px)] lg:w-[336px] lg:min-w-[336px] shrink-0 grow-0 select-none">
      <div className="flex flex-col gap-6">
        <div className="flex gap-3 items-center">
          <div className="relative w-14 h-14 rounded-full overflow-hidden shrink-0">
            <Image src={avatar} alt={name} fill className="object-cover" />
        ...
        <div className="flex flex-col gap-6 lg:gap-12">
          ...
          <div className="flex items-end justify-between">
            ...
            <div className="hidden lg:flex gap-2">
              {/* lp1-nav-arrow — semantic class. Native `disabled`
                  drives enabled/disabled appearance via :disabled. */}
              <button onClick={() => { scrollByCard(-1); pauseAutoScroll(); }} disabled={!canScrollLeft} className="lp1-nav-arrow w-14 h-14 rounded-full flex items-center justify-center">
                <Image src="/icons/arrow-left.svg" alt="Previous" width={19} height={16} />
              </button>
              <button onClick={() => { scrollByCard(1); pauseAutoScroll(); }} disabled={!canScrollRight} className="lp1-nav-arrow w-14 h-14 rounded-full flex items-center justify-center">
                <Image src="/icons/arrow-right.svg" alt="Next" width={19} height={16} />
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-6 lg:hidden items-center">
          ...
          <div className="flex gap-2 items-center">
            <button
              ...
              className="lp1-nav-arrow w-14 h-14 rounded-full flex items-center justify-center"
            >
              <Image src="/icons/arrow-left.svg" alt="Previous" width={19} height={16} />
            </button>
            <button
