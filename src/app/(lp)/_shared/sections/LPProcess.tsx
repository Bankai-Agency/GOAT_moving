...
/* ════════════════════════════════════════════════════════════════
   ...
   mechanic from the original `HowItWorksCard`, BUT:
     ...
     • Accent recolored yellow → brand blue (#0066ff) to match LP.
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          borderRadius: 24,
          background: `radial-gradient(320px circle at ${pos.x}px ${pos.y}px, rgba(0, 102, 255, 0.55), transparent 60%)`,
      ...
      <div
        className="relative z-10 flex items-center justify-center w-14 h-14 lg:w-[88px] lg:h-[88px] [&_svg_path]:!fill-white [&_svg_circle]:!fill-white [&_svg_ellipse]:!fill-white [&>div>svg]:w-7 [&>div>svg]:h-7 lg:[&>div>svg]:w-12 lg:[&>div>svg]:h-12 lp-process-icon-pulse"
        style={{
          borderRadius: 14,
