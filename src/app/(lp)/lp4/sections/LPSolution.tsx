...
/* Per-card spotlight + border glow — same auto-traversing radial
   ...
   (#fffce6); on dark we double them so the blue spotlight is just
...
function LPSolutionCard({ item, index }: { item: IncludedItem; index: number }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="lp-process-icon-pulse relative z-10 flex items-center justify-center [&_svg]:w-10 [&_svg]:h-10 [&_svg_path]:!fill-[#0c0c0c] [&_svg_circle]:!fill-[#0c0c0c] [&_svg_ellipse]:!fill-[#0c0c0c]"
        style={{
          width: 72,
          height: 72,
          borderRadius: 16,
