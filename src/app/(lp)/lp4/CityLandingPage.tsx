                  ...
                  <>
                    ...
                    <div className="flex flex-col gap-2.5 lg:gap-3">
                      <p className="font-sans font-normal text-xl sm:text-2xl lg:text-[28px] leading-[1.3] tracking-[-0.5px] text-white max-w-[560px]">
                        ...
                        <span className="rounded-[4px] bg-[#FFE533] px-1.5 py-0 text-[#181818] font-normal leading-[1.1] [box-decoration-break:clone] [-webkit-box-decoration-break:clone]">$125/hr</span>
                        <br />
