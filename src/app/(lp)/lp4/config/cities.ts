 ...
 *
 * Self-contained — no imports back to `_shared/` (see (lp)/NOTES.md rule #1).
 * Each city reuses the same `LP1Config` shape as `portland.ts`; only the
 * location-specific copy differs. Slugs use the `movers-*` form
 * (`/lp/movers-portland`, `/lp/movers-vancouver-wa`) — matching the
 * existing live/ad URLs.
 */

import type { LP1Config } from "./portland";
 ...
 *  Shift the crop focal point to ~25% from the left on narrow mobile. */
...
export const hillsboroConfig: LP1Config = {
  ...
  socialProofImage: "/lp/hillsboro-city.jpg",
};

export const tigardConfig: LP1Config = {
  slug: "movers-tigard",
  city: "Tigard",
  state: "OR",
  licenseState: "Oregon",
  ...
  socialProofImage: "/lp/tigard-city.jpg",
};

export const lakeOswegoConfig: LP1Config = {
  ...
  socialProofImage: "/lp/lake-oswego-city.jpg",
};

export const oregonCityConfig: LP1Config = {
  ...
  socialProofImage: "/lp/oregon-city-city.webp",
};

export const greshamConfig: LP1Config = {
  slug: "movers-gresham",
  city: "Gresham",
  state: "OR",
  licenseState: "Oregon",
  ...
  socialProofImage: "/lp/gresham-city.jpg",
};

export const happyValleyConfig: LP1Config = {
  ...
  socialProofImage: "/lp/happy-valley-city.jpg",
};

export const salemConfig: LP1Config = {
  slug: "movers-salem",
  city: "Salem",
  state: "OR",
  licenseState: "Oregon",
  ...
  socialProofImage: "/lp/salem-city.png",
};

/* ────────────────────── WASHINGTON ────────────────────── */

export const vancouverWaConfig: LP1Config = {
  ...
  socialProofImage: "/lp/vancouver-wa-city.jpg",
};

export const seattleConfig: LP1Config = {
  slug: "movers-seattle",
  city: "Seattle",
  state: "WA",
  licenseState: "Washington",
  ...
  socialProofImage: "/lp/seattle-city.jpg",
};

export const tacomaConfig: LP1Config = {
  slug: "movers-tacoma",
  city: "Tacoma",
  state: "WA",
  licenseState: "Washington",
  ...
  socialProofImage: "/lp/tacoma-city.jpg",
};

export const redmondConfig: LP1Config = {
  slug: "movers-redmond",
  city: "Redmond",
  state: "WA",
  licenseState: "Washington",
  ...
  socialProofImage: "/lp/redmond-city.jpg",
};

export const issaquahConfig: LP1Config = {
  ...
  socialProofImage: "/lp/issaquah-city.webp",
};

export const everettConfig: LP1Config = {
  slug: "movers-everett",
  city: "Everett",
  state: "WA",
  licenseState: "Washington",
  ...
  socialProofImage: "/lp/everett-city.jpg",
};

/* ────────────────────── REGISTRY ────────────────────── */

/** Master list of all city LPs — used for routing and static generation. */
export const cityLPs: LP1Config[] = [
  portlandConfig,
  hillsboroConfig,
  tigardConfig,
  lakeOswegoConfig,
...
/** Look up a city config by its `/lp/{slug}` slug. */
export function findCityBySlug(slug: string): LP1Config | undefined {
