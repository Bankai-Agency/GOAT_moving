...
function ServiceCard({ title, description, number, image, href }: ServiceItem) {
  ...
  /* lp1-service-card — L2 semantic class. Owns the dark base
     + transitions; Tailwind handles layout. No Tailwind `bg-[#181818]`
     means no theme-light flip to fight. */
  const commonClass =
    "lp1-service-card relative h-[420px] lg:h-[580px] rounded-2xl overflow-hidden flex flex-col justify-between group hover-lift cursor-pointer";
